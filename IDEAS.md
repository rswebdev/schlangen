...
## Return to last used settings on HouseRulesView.swift

When stopping the server and returning to HouseRulesView show the last used settings, instead of the default rules
